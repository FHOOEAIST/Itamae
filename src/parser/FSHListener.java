...
public interface FSHListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link FSHParser#mixins}.
	 * @param ctx the parse tree
	 */
	void enterMixins(FSHParser.MixinsContext ctx);
	/**
	 * Exit a parse tree produced by {@link FSHParser#mixins}.
	 * @param ctx the parse tree
	 */
	void exitMixins(FSHParser.MixinsContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link FSHParser#paths}.
	 * @param ctx the parse tree
	 */
	void enterPaths(FSHParser.PathsContext ctx);
	/**
	 * Exit a parse tree produced by {@link FSHParser#paths}.
	 * @param ctx the parse tree
	 */
	void exitPaths(FSHParser.PathsContext ctx);
	/**
